            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.insert_drive_file_outlined, size: 52, color: primaryBlue.withOpacity(0.58)),
                      const SizedBox(height: 14),
                      const Text(
                        'Tidak ada kebijakan yang dibuat',
                        style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17, color: primaryBlue),
                      ),
                      const SizedBox(height: 6),
                      const Text(
                ...
                children: [
                  ...
                  StreamBuilder<List<ReimbursementRequest>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final docs = all
                          .where(
                            (r) => r.createdAt.month == selectedMonth.month && r.createdAt.year == selectedMonth.year,
                          )
                          .toList();
                      if (docs.isEmpty) {
                        return const Padding(
                      ...
                      return Column(
                        children: docs.map((r) {
                          ...
                          if (desc.contains("makan")) icon = Icons.restaurant;
                          if (desc.contains("mobil") || desc.contains("bensin")) icon = Icons.local_gas_station;
                          if (desc.contains("transport")) icon = Icons.directions_bus_filled_rounded;
                          return ListTile(
                            ...
                            subtitle: Text(
                              ...
                              style: TextStyle(color: Colors.grey[700], fontSize: 13.2),
                            ),
                            trailing: Text(
                              NumberFormat.currency(locale: 'id_ID', symbol: 'Rp', decimalDigits: 0).format(r.amount),
                              style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.black, fontSize: 14.5),
                            ),
                          );
                        }).toList(),
                      );
...
class _ReimbursementFormPageState extends State<ReimbursementFormPage> {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        DateFormat('MMMM yyyy', 'id_ID').format(tempDate).toUpperCase(),
                  ...
                  children: ['Min', 'Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab'].map(
                        (day) => SizedBox(
                          ...
                          child: Text(
                            day,
                            textAlign: TextAlign.center,
                            style: const TextStyle(fontWeight: FontWeight.bold, color: _primaryBlue, fontSize: 12),
                          ),
                        ),
                      ).toList(),
                ),
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        setStateDialog(() { tempDate = date; });
                      },
                      child: Container(
                        margin: const EdgeInsets.all(3),
                        decoration: BoxDecoration(
                          color: isSelected ? _primaryBlue : isCurrentDay ? Colors.blue.withOpacity(0.18) : Colors.transparent,
                          border: isCurrentDay && !isSelected ? Border.all(color: Colors.blue, width: 2) : null,
                          borderRadius: BorderRadius.circular(8),
                        ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: const Text('Pilih', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
                    ),
                  ],
                ),
              ],
  ...
  Future<void> _submit() async {
    ...
    if (_items.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Tambahkan minimal 1 item benefit')));
      return;
    }
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('reimbursement_requests').add({
        ...
        'benefitItems': _items.map((e) => {'name': e.name, 'amount': e.amount}).toList(),
        'createdAt': now,
      });
  ...
  Widget build(BuildContext context) {
    final hPad = 12.0;
    final tStyleHint = TextStyle(color: Colors.grey[700], fontSize: 12.8);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          ...
          style: TextStyle(fontWeight: FontWeight.bold, color: _primaryBlue, fontSize: 20),
        ),
      ),
      body: AbsorbPointer(
        absorbing: _loading,
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: const [
                        DropdownMenuItem(
                          value: 'Standar Reimbursement',
                          child: Text('Standar Reimbursement'),
                        ),
                        DropdownMenuItem(
                          value: 'Kesehatan',
                    ...
                    const SizedBox(height: 17),
                    // Lampiran
                    const Text('Lampiran', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black, fontSize: 14)),
                      ...
                      children: [
                        for (final f in _files)
                          Chip(
                            ...
                            label: Text(f.name, style: const TextStyle(color: Colors.black)),
                        ...
                        GestureDetector(
                          onTap: _pickFiles,
                          child: DottedBorder(
                            // strokeColor: const Color.fromARGB(255, 7, 7, 250),
                            ...
                            child: Container(
                              ...
                              height: 56,
                              color: _greyBg,
                              child: const Icon(Icons.add, size: 27, color: _primaryBlue),
                            ),
                          ),
                        ),
                      ],
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Item benefit", style: TextStyle(fontWeight: FontWeight.bold, color: _primaryBlue, fontSize: 15)),
                    const SizedBox(height: 6),
                    Text('Rincian benefit yang akan diajukan', style: tStyleHint),
                    const SizedBox(height: 8),
                      ...
                      Column(
                        children: [
                          ..._items.map(
                              ...
                              leading: const Icon(Icons.table_chart_rounded, color: _primaryBlue, size: 21),
                              title: Text(
                                e.name,
                              ...
                              trailing: Row(
                                ...
                                children: [
                                  Text(
                                    NumberFormat.currency(locale: 'id_ID', symbol: 'Rp', decimalDigits: 0).format(e.amount),
                                    style: const TextStyle(fontWeight: FontWeight.bold, color: _primaryBlue, fontSize: 14),
                                  ),
                                  const SizedBox(width: 10),
                                  GestureDetector(
                                    onTap: () => setState(() => _items.remove(e)),
              ...
              // Total jumlah pengajuan dan tombol biru bawah
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  const Text(
                    "Total Jumlah pengajuan",
                    style: TextStyle(color: Colors.black87, fontWeight: FontWeight.w500, fontSize: 14.5),
                  ),
                  Text(
                    NumberFormat.currency(locale: 'id_ID', symbol: 'Rp', decimalDigits: 0).format(_total),
                    style: const TextStyle(color: _primaryBlue, fontWeight: FontWeight.bold, fontSize: 17),
                  ),
                ],
              ),
              const SizedBox(height: 14),
                ...
                child: ElevatedButton(
                  ...
                  child: _loading
                      ? const SizedBox(
                          width: 23, height: 23,
                          child: CircularProgressIndicator(
                            color: Colors.white, strokeWidth: 2.8),
                        )
